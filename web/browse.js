...
import {
  attachClipHoverPlayback, isClip, isClipConvertable,
} from './clipPlayback.js';

// browse.js 외부 surface 보존: 기존 `export function isClip` 를 사용하던
// 호출 사이트 회귀 방지용 re-export. 현재 외부 import 0건 확인됨이지만
// 보수적으로 유지 (BD-1 plan §6 #8).
export { isClip };
