...
export const $ = {
  ...
  convertPNGAllBtn:        document.getElementById('convert-png-all-btn'),
  convertImageModal:       document.getElementById('convert-image-modal'),
  convertImageFileList:    document.getElementById('convert-image-file-list'),
  convertImageDeleteOrig:  document.getElementById('convert-image-delete-original'),
  convertImageError:       document.getElementById('convert-image-error'),
  convertImageResult:      document.getElementById('convert-image-result'),
  convertImageRows:        document.getElementById('convert-image-rows'),
  convertImageSummary:     document.getElementById('convert-image-summary'),
  convertImageCancelBtn:   document.getElementById('convert-image-cancel-btn'),
  convertImageConfirmBtn:  document.getElementById('convert-image-confirm-btn'),
  ...
  convertWebpError:        document.getElementById('convert-webp-error'),
  convertWebpResult:       document.getElementById('convert-webp-result'),
  convertWebpRows:         document.getElementById('convert-webp-rows'),
  convertWebpSummary:      document.getElementById('convert-webp-summary'),
  convertWebpCancelBtn:    document.getElementById('convert-webp-cancel-btn'),
  convertWebpConfirmBtn:   document.getElementById('convert-webp-confirm-btn'),
