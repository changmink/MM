...
- [ ] C4: E2E 수동 검증 — plan.md Phase 15 C4의 9개 시나리오 통과 (단일 변환 / 원본 유지 / 원본 삭제 + 사이드카 정리 / 409 충돌 / 폴더 일괄 3개 / 취소 + tmp 정리 / ffmpeg_error / 필터 연동 / 모바일 / 기존 기능 회귀). **Docker 이미지 `fs_ts_smoke-server` 빌드 완료 상태.**
